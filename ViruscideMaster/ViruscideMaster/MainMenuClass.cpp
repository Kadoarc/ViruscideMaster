...
MainMenuClass::MainMenuClass(sf::Vector2f _position, sf::Vector2f _size, std::string _texturePath, std::string _controlScreenPath)
{
	...
	PlayButton = ButtonClass(sf::Vector2f(1200 / 2, 1200 / 2), sf::Vector2f(425.0f, 133.0f), std::string("Resources/Images/ViruscideMenuPlayButton.png"),
	...
	ControlsButton = ButtonClass(sf::Vector2f(1200 / 2, (1200 / 2) + 153.0f), sf::Vector2f(425.0f, 133.0f), std::string("Resources/Images/ViruscideControlsButtons.png"),
	...
	QuitButton = ButtonClass(sf::Vector2f(1200 / 2, (1200 / 2) + 306.0f), sf::Vector2f(425.0f, 133.0f), std::string("Resources/Images/ViruscideMenuQuitButton.png"),
	...
	BackButton = ButtonClass(sf::Vector2f(1200 / 2, (1200 / 2) + 306.0f), sf::Vector2f(425.0f, 133.0f), std::string("Resources/Images/ViruscideBackButton.png"),
...
void MainMenuClass::update(sf::RenderWindow & window)
{
...
void MainMenuClass::handleEvent(sf::RenderWindow & window)
{
}
